<template>
  <div v-if="attackEngine" class="imu-attack-settings">
    <b-form @submit="onSubmit">
      ...
      <b-form-row>
        ...
        <div :id="sensorName + '-settings-column2'" class="col">
          <SettingEntry
            :id="sensorName + '-offset-orientation'"
            label="Offset Orientation [°]:"
            type="number"
            placeholder="Enter the orientation offset."
            tooltip="The constant offset in orientation in degree."
            :step="0.001"
            v-model="attackEngine.offsetValue.orientation"
          />

          <SettingEntry
            :id="sensorName + '-spoofed-orientation'"
            label="Spoofed Orientation [°]:"
            type="number"
            placeholder="Enter the spoofed orientation."
            tooltip="The spoofed orientation in degree."
            :step="0.001"
            v-model="attackEngine.spoofedValue.orientation"
          />
