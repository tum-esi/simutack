...
class IMUSensorHandler(SensorHandler):
    ...
    def sensor_update(self, data: tuple, annotation: AnnotationData):
        """
    ...
    class TornadoHandler(SensorHandler.TornadoHTTPHandler):
        ...
        def get(self):
            logger.debug("POST message received. Reply data of {}.".format(
        ...
        def post(self):
            logger.debug("POST message received. Update settings for {}.".format(
                self.handler.sensor_name))
            ...
            try:
                ...
                if 'offsetValue' in attack_engine:
                    ...
                    value = (value / 180.0) * math.pi  # convert degree to rad
